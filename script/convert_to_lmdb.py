...
if __name__ == "__main__":
    ...
    infiles = glob.glob(os.path.join("/content/drive/MyDrive/vilbert-multi-task/datasets/vsnli/extracted_features", "*"))
    id_list = []
    env = lmdb.open("/content/drive/MyDrive/vilbert-multi-task/datasets/vsnli/vsnli_extracted_features.lmdb", map_size=MAP_SIZE)
    print(infiles)
